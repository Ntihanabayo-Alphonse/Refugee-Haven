...
const Footer = () => {
    return (
        <>
            {/* Footer Section */}
            <div className="flex justify-between flex-col md:flex-row lg:px-28 px-10 py-16 bg-[#333333]">
                <div className="md:w-[300px] w-[90%] m-auto md:m-0">
                    <div className="logo h-20 w-20 bg-[#E9E4D3] rounded-full m-auto md:m-0">
                        <Link to="/"><img className='w-full h-full  object-cover' src={refugeeHavenLogo} alt="refugee haven logo" /></Link>
                    </div>
                    <p className='text-[#E9E4D3] my-8 text-sm md:text-[16px]'>Refugee Haven is a compassionate, community-centered organization dedicated to empowering refugees and displaced individuals on their journey to rebuilding lives.</p>
